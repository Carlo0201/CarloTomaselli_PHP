...
<html>
    ...
    <body>
        ...
        <form method="post">
            <button class="form-control btn btnform" type="submit" name="addAutore">Aggiungi autore</button>
            <button class="form-control btn btnform" type="submit" name="addGenere">Aggiungi genere</button>
            <button class="form-control btn btnform" type="submit" name="addLibro">Aggiungi libro</button>
        </form>
                    ...
                    while($riga = $risultato->fetch_assoc()) {
                        ...
                        <tr>
                            ...
                            if($riga["id_prestito"]==1){
                                echo "<td><button class='available form-control btn' onclick='presta(".$riga["id"].")'>presta</button></td>";
                            }
                            else{
                                echo "<td><button class='unavailable form-control btn' onclick='dettagli(".$riga["id"].")'>dettagli</button></td>";
                            }
